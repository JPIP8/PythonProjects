...
def pprint_2(a, b, _min_, _std_):
    ...
    for line in a:
        i = 0
        print(
            f"{'MEAN Petal Length: ':<25} {a['setosa'][i]:<12.2f} {a['versicolor'][i]:<13.2f} {a['virginica'][i]:<13.2f}")
        i = +1
    ...
    print(
        f"{'MAX Petal Length: ':<25} {b['setosa']['max_sepal_width']:<12.2f} {b['versicolor']['max_sepal_width']:<13.2f} {b['virginica']['max_sepal_width']:<13.2f}")
    print(
        f"{'MAX Petal Length: ':<25} {b['setosa']['max_petal_length']:<12.2f} {b['versicolor']['max_petal_length']:<13.2f} {b['virginica']['max_petal_length']:<13.2f}")
    print(
        f"{'MAX Petal Length: ':<25} {b['setosa']['max_petal_width']:<12.2f} {b['versicolor']['max_petal_width']:<13.2f} {b['virginica']['max_petal_width']:<13.2f}")
    print('-------------------------------------------------------------------')
    ...
    print(
        f"{'MIN Petal Length: ':<25} {_min_['setosa']['max_sepal_width']:<12.2f} {_min_['versicolor']['max_sepal_width']:<13.2f} {_min_['virginica']['max_sepal_width']:<13.2f}")
    print(
        f"{'MIN Petal Length: ':<25} {_min_['setosa']['max_petal_length']:<12.2f} {_min_['versicolor']['max_petal_length']:<13.2f} {_min_['virginica']['max_petal_length']:<13.2f}")
    print(
        f"{'MIN Petal Length: ':<25} {_min_['setosa']['max_petal_width']:<12.2f} {_min_['versicolor']['max_petal_width']:<13.2f} {_min_['virginica']['max_petal_width']:<13.2f}")
    print('-------------------------------------------------------------------')
    ...
    print(
        f"{'Std Dev Petal Length: ':<25} {_std_['setosa']['max_sepal_width']:<12.2f} {_std_['versicolor']['max_sepal_width']:<13.2f} {_std_['virginica']['max_sepal_width']:<13.2f}")
    print(
        f"{'Std Dev Petal Length: ':<25} {_std_['setosa']['max_petal_length']:<12.2f} {_std_['versicolor']['max_petal_length']:<13.2f} {_std_['virginica']['max_petal_length']:<13.2f}")
    print(
        f"{'Std Dev Petal Length: ':<25} {_std_['setosa']['max_petal_width']:<12.2f} {_std_['versicolor']['max_petal_width']:<13.2f} {_std_['virginica']['max_petal_width']:<13.2f}")
    print('-------------------------------------------------------------------')
